...
var _drawCircles = _interopRequireDefault(require("./drawCircles"));
...
function () {
  function Heatmap(config) {
    ...
    this.config = Object.assign({}, config, _defaultConfig.default);
  ...
  _createClass(Heatmap, [{
    ...
    value: function render() {
      ...
      var ctx = this.ctx,
          data = this.data;
      (0, _drawCircles.default)(ctx, data); // generate gradient color palette

      this.gradientColorScale = (0, _colorPalette.default)(this.config.color); // colorize according to alpha value
